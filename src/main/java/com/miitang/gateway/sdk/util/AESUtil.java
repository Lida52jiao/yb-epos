...
public class AESUtil {
    ...
    public static byte[] encryptAES(byte[] plainBytes, byte[] keyBytes, boolean useBase64Code, String charset)
            throws Exception {
        try {
     ...
     * @return byte[]
     */
    public static byte[] decryptAES(byte[] cryptedBytes, byte[] keyBytes, boolean useBase64Code, String charset)
            throws Exception {
        ...
        try {
            ...
            e.printStackTrace();
            throw new MtSdkException("AES解密失败");
        }
    }
}
